...
- [AppStore Interfaces](#appstore-interfaces)
  ...
  - [2. Package](#2-Package)
    ...
    - [2.16 APP unpublish](#216-App-Unpublish)
  - [3. Comment](#3-Comment)
...
Unpublish application package by application id and package id.

```
Resource URI: /mec/appstore/v1/apps/{appId}/packages/{packageId}/action/unpublish
Method: POST
```
