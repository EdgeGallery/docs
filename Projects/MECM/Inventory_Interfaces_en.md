...
- [Inventory Interfaces](#appo-interfaces)
  - [1. App Lcm Inventory Handler](#1-app-instance-info-handler)
    - [1.1 Get All Application LCM Records](#11-get-application-lcm-records)
    - [1.2 Add Applcm Record](#12-add-applcm-record)
    - [1.3 Delete All Applcm Record](#13-delete-applcm-record)
  ...
  - [2.App Store Inventory Handler](#2-app-store-inventory-handler)
    - [2.1 Get All Application Records ](#21-get-application-records)
    - [2.2 Add Application Store Record](#22-add-application-store-record)
    - [2.3 Delete All Application Records](#23-delete-application-records)
