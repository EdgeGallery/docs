...
- 在管理面，管理员可以管理测试场景、测试套、测试用例、测试任务以及贡献的测试用例，其中贡献管理的菜单仅管理员可见。平台内置了4种测试场景：社区场景、中国移动场景、中国联通场景和中国电信场景。对于社区场景，平台内置了通用安全性测试测试套、通用遵从性测试测试套和通用沙箱测试测试套，每个测试套下面都有对应的测试用例。对于有手工用例的测试任务，管理员可以在后台手动更改测试用例状态，完成手工测试用例状态的更新。
